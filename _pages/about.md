...
<details>
  ...
  <ul>
    <li> 
      In <a href="https://osf.io/preprints/socarxiv/qpmce" class="external">one behavioral study</a>, I found Democrats voiced unpopular opinions more readily to Republicans than to fellow Democrats, suggesting that self-censorship often reflects in-group dynamics, not just fear of the opposition. 
    </li>
    <li>
      In an “outnumbered” experiment using our custom platform, participants surrounded by opposing viewpoints felt less comfortable sharing opinions and evaluated both the platform and other users more negatively (<a href="https://osf.io/preprints/osf/tygec" class="external">paper here</a>).
    </li>
  </ul>
...
<details>
  ...
  <p>
  In a collaboration published in <a href="https://www.nature.com/articles/s41598-023-39359-0" class="external"><em>Nature Scientific Reports</em> (2023)</a>, we built a custom chat app and randomly assigned gender labels to discussion partners. Misrepresenting a man as a woman reduced his influence, while misrepresenting a woman as a man did not improve hers.
  </p>
